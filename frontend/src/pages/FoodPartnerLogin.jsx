...
const FoodPartnerLogin = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Partner Login:', formData.email);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-gray-100">
        <div className="text-center">
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900">Partner Login</h2>
          <p className="mt-2 text-sm text-gray-500">Manage your orders and menu.</p>
        </div>
        ...
        <div className="text-center text-sm">
          ...
          <Link to="/food-partner/register" className="font-medium text-black hover:underline focus:outline-none">
            Register 
          </Link>
        </div>
      </div>
